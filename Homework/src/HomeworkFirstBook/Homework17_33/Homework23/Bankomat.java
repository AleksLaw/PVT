package HomeworkFirstBook.Homework17_33.Homework23;
...
public class Bankomat {
    ...
    public void start() {
        ...
        while (a != 5) {
            ...
            if (a >= 1 && a <= 5) {
                if (a == 1) {
                    while (a != 4) {
                        a = readInteger(scanner, "В какую ячейку вы хотите добавить?\n 1-в ячейку 20$, 2-в ячейку 50$, 3-в ячейку 100$, 4-назад в меню");
                        if (a >= 1 && a <= 5) {
                            if (a == 1) {
                                add$20();
                            } else if (a == 2) {
                        ...
                        } else System.out.println("Нет такого меню");
                    }
                } else if (a == 2) {
                    printTotal();
                } else if (a == 3) {
    ...
    public static int readInteger(Scanner scanner, String message) {
        ...
        do {
            ...
            if (a < 0) {
                System.out.println("Слишком мало, не жадничайте");
            } else {
                return a;
            }
